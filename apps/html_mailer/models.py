...
class Message(models.Model):
    ...
    message_html = tinymce_models.HTMLField(null=True, blank=True)
    ...
    def __unicode__(self):
        return u'Сообщение для %s' % self.to_address

    class Meta:
        verbose_name        = u"cообщение"
        verbose_name_plural = u"oчередь сообщений"
...
class DontSendEntry(models.Model):
    ...
    class Meta:
        ...
        verbose_name_plural = u'адреса, куда не делать рассылку'
...
class MessageLog(models.Model):
    ...
    class Meta:
        verbose_name_plural = u"Лог рассылки"
