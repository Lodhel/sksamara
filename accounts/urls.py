...
urlpatterns = patterns(
    ...
    url(r'^company_reset_password', 'accounts.views.company_reset_password', name="company-reset-password"),
    url(r'^company_reset_target', 'accounts.views.company_reset_target', name="company-reset-target"),
    url(r'^company_send_sms', 'accounts.views.company_send_sms', name="company-send-sms"),
